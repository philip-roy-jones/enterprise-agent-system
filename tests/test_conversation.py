...
from enterprise.conversation import Conversation
from enterprise.types import JobInput, Stale, Stopped
...
def test_agent_question_waits_without_model_calls_then_resumes_with_staff_answer(store, job, monkeypatch):
    monkeypatch.setattr("enterprise.assistance.SimulatedModel", QuestionModel)
