...
| 3. Cyclic role graph | `src/edge-harness/eas_harness/workflows/finance/graph.py`: validate, establish, compare, prepare, save, verify, recover, assist, resume, and complete. Unknown requests also enter supervised discovery. |
