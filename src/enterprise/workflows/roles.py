...
def _invoice_graph(*args, **kwargs):
    from enterprise.workflows.finance.graph import RoleGraph
...
def _browser_adapter(settings, store):
    if settings.desktop_adapter == "windows_accessibility":
        from enterprise.harness.adapters.accessibility_adapter import AccessibilityAdapter
    ...
    from enterprise.harness.adapters.adapter import ThreadedBrowserAdapter
