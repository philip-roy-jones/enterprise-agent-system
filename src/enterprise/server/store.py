...
from enterprise.shared.types import TERMINAL, Stale, Stopped
...
class Store:
    ...
    def create_job(self, inputs, model_mode="simulated", timeout=900):
        from enterprise.workflows.roles import get_role
    ...
    def add_knowledge(self, document):
        from enterprise.shared.types import KnowledgeDocument
        from enterprise.workflows.roles import get_role
