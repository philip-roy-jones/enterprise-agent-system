...
from enterprise.shared.types import Observation, Recovery, Stale
from enterprise.harness.adapters.windows_adapter import WindowsAdapter, WindowsBridge
from enterprise.shared.contracts import adapter_contract, SaveInputs, DraftResult
