...
def main():
    ...
    if options.command == "serve":
        ...
        from enterprise.harness.worker import run_worker
        ...
        from enterprise.development.demo import main as demo

        demo(options.args)
    else:
        from enterprise.development.improve import main as improve
