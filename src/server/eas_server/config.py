...
class Settings:
    ...
    oidc_issuer: str = os.getenv("EAS_OIDC_ISSUER", "")
    oidc_audience: str = os.getenv("EAS_OIDC_AUDIENCE", "")
    oidc_jwks_url: str = os.getenv("EAS_OIDC_JWKS_URL", "")
    oidc_authorization_url: str = os.getenv("EAS_OIDC_AUTHORIZATION_URL", "")
    oidc_token_url: str = os.getenv("EAS_OIDC_TOKEN_URL", "")
    oidc_client_secret: str = field(default=os.getenv("EAS_OIDC_CLIENT_SECRET", ""), repr=False)
